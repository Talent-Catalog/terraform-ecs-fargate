# Copy of standard configuration plus changes taken from
# https://github.com/apache/superset/blob/master/docker/pythonpath_dev/superset_config.py
# plus special configuration which should at least include
# SECRET_KEY - randomly generated unique string for this instance of Superset
...
# The main ones that must be present so that Superset can connect to its internal
# database are:
#
# DATABASE_DIALECT
# DATABASE_USER
